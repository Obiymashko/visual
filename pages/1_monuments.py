...
# ---------------------------------------------------------------------
# 4. Вертикальний графік: "Об'єкти в єПам'ятці (виборка)"
# ---------------------------------------------------------------------
st.subheader("Внесено об'єктів культурної спадщини в єПам'ятку за регіонами")

# Нові дані зі скріншоту
selection_data = {
    "Регіон": [
        "Вінницька обл.", "Волинська обл.", "Дніпропетровська обл.", "Донецька обл.",
        "Житомирська обл.", "Закарпатська обл.", "Запорізька обл.", "Івано-Франківська обл.",
        "Київська обл.", "Кіровоградська обл.", "Луганська обл.", "Львівська обл.",
        "м. Київ", "Миколаївська обл.", "Одеська обл.", "Полтавська обл.",
        "Рівненська обл.", "Сумська обл.", "Тернопільська обл.", "Харківська обл.",
        "Херсонська обл.", "Хмельницька обл.", "Черкаська обл.", "Чернівецька обл.",
        "Чернігівська обл."
    ],
    "Об'єкти": [
        4457, 1512, 9358, 6719,
...
# Створюємо DataFrame та сортуємо від найбільшого до найменшого (красива драбинка)
df_selection = pd.DataFrame(selection_data).sort_values(by="Об'єкти", ascending=False)
